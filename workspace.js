...
cprequire_test(["inline:com-chilipeppr-workspace-robz1"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-robz1", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-robz1", // Make the id the same as the cpdefine id
        name: "Workspace / Sample - RobZ", // The descriptive name of your widget.
        ...
        /**
         * Load the NEW Serial Port JSON Server widget via chilipeppr.load()
         */
        ...
        loadSpjsWidget: function(callback) {
            ...
            chilipeppr.load(
              "#myDivWidgetSerialportRobz",
              "http://raw.githubusercontent.com/robZeilinga/widget-spjs/master/auto-generated-widget.html",
              function() {
                // Callback after widget loaded into #myDivWidgetSerialportRobz
                // Now use require.js to get reference to instantiated widget
                cprequire(
                  ["inline:com-chilipeppr-widget-serialport-robz"], // the id you gave your widget
                  function(myObjWidgetSerialportRobz) {
                    // Callback that is passed reference to the newly loaded widget
                    console.log("Widget / Serial Port JSON Server just got loaded.", myObjWidgetSerialportRobz);
                    myObjWidgetSerialportRobz.init();
                  }
                );
              }
            );
