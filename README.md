# com-chilipeppr-workspace-robz1
A ChiliPeppr Workspace sample.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / Sample - RobZ
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-robz1 |
| Name                  | Workspace / Sample - RobZ |
| Description           | A ChiliPeppr Workspace sample. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/robZeilinga/workspace-Rob1/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/robzedweb/chilipeppr-testworkspace-rob1 |
| Github URL            | http://github.com/robZeilinga/workspace-Rob1 |
| Test URL              | https://preview.c9users.io/robzedweb/chilipeppr-testworkspace-rob1/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/robZeilinga/workspace-Rob1/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-robz1"], // the id you gave your workspace
      function(myWorkspaceRobz1) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / Sample - RobZ just got loaded.", myWorkspaceRobz1);
        myWorkspaceRobz1.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-robz1"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / Sample - RobZ"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace sample."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/robZeilinga/workspace-Rob1/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/robzedweb/chilipeppr-testworkspace-rob1"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/robZeilinga/workspace-Rob1"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://chilipeppr-testworkspace-rob1-robzedweb.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
...
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadSpjsWidget</td><td>function</td><td>function (callback) <br><br>Load the NEW Serial Port JSON Server widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadConsoleWidget</td><td>function</td><td>function (callback) <br><br>Load the Console widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadWorkspaceMenu</td><td>function</td><td>function (callback) <br><br>Load the workspace menu and show the pubsubviewer and fork links using
